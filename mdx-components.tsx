...
const components = {
  ...
  h2: (props: HeadingProps) => <h2 className='text-gray-800 dark:text-zinc-200 font-medium mt-8 mb-4' {...props} />,
  h3: (props: HeadingProps) => <h3 className='text-gray-800 dark:text-zinc-200 font-medium mt-8 mb-4' {...props} />,
  h4: (props: HeadingProps) => <h4 className='font-medium' {...props} />,
  p: (props: ParagraphProps) => <p className='text-gray-800 dark:text-zinc-300 leading-snug mb-3' {...props} />,
