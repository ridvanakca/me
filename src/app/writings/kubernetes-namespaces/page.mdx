...
When you first create a cluster, Kubernetes provides four namespaces out of the box. You can list them with the command:
...
You’re not limited to the default ones. You can create your own namespaces using a simple command:

```bash
kubectl create namespace my-namespace
```

Or by defining them in a configuration file. This flexibility allows you to better organize applications as they grow in complexity.
